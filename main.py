...
# chi_functions.createnetwork(officer_ids=tice_ids, company_numbers=['11694875', '13277309', '13007844'], overwrite_neo4j=True, save_json_path=save_json)
...
chi_functions.loadjsoncreategraph(save_json, overwrite_neo4j=True, group_officers=True)
